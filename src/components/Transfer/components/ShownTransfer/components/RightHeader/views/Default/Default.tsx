...
import { TransferDefaultClearButton, TransferDefaultHeaderLabel } from './components';
...
export const TransferDefaultRightHeaderView: FC = () => {
    ...
    return (
        <StyledTransformRightSideHeader size={size} data-size={size}>
            <TransferDefaultHeaderLabel text="Vybráno:" />
            <TransferDefaultClearButton onClick={handleReset}>Odstranit vše</TransferDefaultClearButton>
